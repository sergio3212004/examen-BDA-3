...
Persistent desktop sidebar and responsive top navigation. It receives the active section and overall progress, and emits `select`.
...
The root component is the app shell and state coordinator. It renders `AppSidebar`, then a `main` area. Theme-specific workspaces replace the standard page with a sticky horizontal sub-navigation containing “Contenido”, “Quiz”, and “Actividades”. Full source: `src/App.vue` (310 lines).
